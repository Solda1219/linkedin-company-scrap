...
class LinkedinComScraper():
    ...
    def __init__(self):
        ...
        self.scrape_date = (date.today()-timedelta(1)).strftime("%d/%m/%Y")
    ...
    def scrape(self, row, driver):
        try:
            ...
            for itemNode in itemNodes:
                ...
                print(newPage)
            if(newPage== []):
                new = {'url': intendedUrl, 'activity_id': "", 'follower_count': followerCount,'date': "0", 'description': "", 'reaction_count': 0, 'comment_count': 0}
                newPage.append(new)
                print(newPage)
